...
import gleam.infrastructure.DynamicMacro
import gleam.Generator
import gleam.Macro
import gleam.{ Node => GNode }
import gleam.compiler.node.PModifier
...
import gleam.compiler.typing.{ Type => GType }

import ArgumentSource._
import gleam.ClassOutputter
import gleam.OutputClass
...
//    setLineNumber(mv, startOrContinueLabel(node), lineNumberProvider.getLineNumber(node))
  ...
  override def outAView(node : AView) {
    if (node.getStmt().size() > 0) {
      ...
      mv.visitLocalVariable("scope", "Lgleam/infrastructure/Scope;", null, l0, l3, 1)
      mv.visitLocalVariable("nodes", "Ljava/util/List;", "Ljava/util/List<Lgleam/Node;>;", l0, l3, 2)
  ...
  override def inAView(node : AView) {
    ...
    if (node.getStmt().size() > 0) {
      ...
      classWriter.visit(V1_6, ACC_PUBLIC + ACC_SUPER, viewname, null, "gleam/View", Array[String]())
      ...
      // Constructor
      {
        ...
        mv.visitMethodInsn(INVOKESPECIAL, "gleam/View", "<init>", "()V")
      ...
      // Create the view method
      {
        ...
        val mv = classWriter.visitMethod(
            ACC_PUBLIC, "view", "(Ljava/lang/Object;)Ljava/util/List;", "(Ljava/lang/Object;)Ljava/util/List<Lgleam/Node;>;", null)
        methodVisitors.push(mv)
        mv.visitCode()
  ...
  override def inAMacroDefn(node : AMacroDefn) {
    ...
    val (parentClass, interfaces) = if (macroDefinition.isAbstract) {
      ("gleam/infrastructure/RuntimeTypedMacro", Array[String]())
    } else if (macroDefinition.isDynamic) {
      ("gleam/infrastructure/DynamicMacro", Array[String]())
    } else {
      ("java/lang/Object", Array[String]("gleam/Macro"))
    }
    cw.visit(V1_6, ACC_SUPER + ACC_PUBLIC, className, null, parentClass, interfaces)
    cw.visitSource(sourcename, null)

    // Instance field for the macro
    val fv = cw.visitField(ACC_PRIVATE + ACC_STATIC, "instance", "Lgleam/Macro;", null, null)
    fv.visitEnd()
    ...
    // Static constructor
    {
      ...
      NEW(className) { }
      mv.visitFieldInsn(PUTSTATIC, className, "instance", "Lgleam/Macro;")
    ...
    // getInstance method
    {
      val mv = cw.visitMethod(ACC_STATIC | ACC_PUBLIC, "getInstance", "()Lgleam/Macro;", null, null)
      mv.visitCode()

      mv.visitFieldInsn(GETSTATIC, className, "instance", "Lgleam/Macro;")
      mv.visitInsn(ARETURN)
      mv.visitMaxs(0, 0)
      mv.visitEnd();
    } 
    ...
    if (!macroDefinition.isDynamic && !macroDefinition.isAbstract) {
      ...
      val mv = cw.visitMethod(ACC_PUBLIC, 
          "invoke", 
          "(Lgleam/infrastructure/Scope;Ljava/util/Map;Ljava/lang/Object;)Ljava/util/List;",
          "(Lgleam/infrastructure/Scope;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/lang/Object;)Ljava/util/List<Lgleam/Node;>;", null)
      methodVisitors.push(mv)
      mv.visitCode()
      ...
      mv.visitLocalVariable("callerScope", "Lgleam/infrastructure/Scope;", null, l0, l6, 1)
      ...
      mv.visitLocalVariable("scope", "Lgleam/infrastructure/Scope;", null, l0, l6, 4)
    }
  ...
  override def outAMacroDefn(node : AMacroDefn) {
    ...
    if (!macroDefinition.isDynamic && !macroDefinition.isAbstract) {
      ...
      INVOKE(classOf[Generator], "view", "(Lgleam/infrastructure/Scope;)Ljava/util/List;")
      // nodes
  ...
  override def caseANodeDefn(node : ANodeDefn) {
    ...
    val interfaces = Array[String]("gleam/Macro")
    ...
    // Invoke method
    {
      ...
      NEW(classOf[gleam.Node], classOf[java.util.List[_]], classOf[String], classOf[Object]) {
        node.getType match {
          case null => 
            mv.visitInsn(ACONST_NULL)
  ...
  override def inAGenerator(node : AGenerator) {
    ...
    innerClassWriter.visit(V1_6, ACC_SUPER, viewname + "$" + generatorName, null, "java/lang/Object", Array[String]("gleam/Generator"))
    ...
    val fv = innerClassWriter.visitField(ACC_PRIVATE + ACC_STATIC, "instance", "Lgleam/Generator;", null, null)
    fv.visitEnd()
    ...
    // Static constructor
    {
      ...
      // Initialise the instance
      NEW(fullClassName) { }
      mv.visitFieldInsn(PUTSTATIC, fullClassName, "instance", "Lgleam/Generator;")
    ...
    // getInstance method
    {
      val mv = innerClassWriter.visitMethod(ACC_STATIC | ACC_PUBLIC, "getInstance", "()Lgleam/Generator;", null, null)
      mv.visitCode()

      val l1 = new Label()
      mv.visitLabel(l1)
      mv.visitFieldInsn(GETSTATIC, fullClassName, "instance", "Lgleam/Generator;")
      mv.visitInsn(ARETURN)
      mv.visitMaxs(0, 0)
      mv.visitEnd(); 
    } 
    ...
    // Create the view method
    {
      ...
      val mv = innerClassWriter.visitMethod(
          ACC_PUBLIC, "view", "(Lgleam/infrastructure/Scope;)Ljava/util/List;", "(Lgleam/infrastructure/Scope;)Ljava/util/List<Lgleam/Node;>;", null)
      methodVisitors.push(mv)
      mv.visitCode()
  ...
  override def outAGenerator(node : AGenerator) {
    ...
    mv.visitMethodInsn(Opcodes.INVOKESTATIC, generatorIdentifier, "getInstance", "()Lgleam/Generator;") // macro, value, args
  }
...
//    setLineNumber(mv, startOrContinueLabel(node), lineNumberProvider.getLineNumber(node))
  ...
  private def outDynamicMacroAssignment(node : AAssignmentStmt) {
    ...
    mv.visitMethodInsn(Opcodes.INVOKESTATIC, dynamicMacroName, "getInstance", "()Lgleam/Macro;") // target
    CHECKCAST(classOf[DynamicMacro])
    mv.visitMethodInsn(Opcodes.INVOKESTATIC, sourceClassName, "getInstance", "()Lgleam/Macro;") // target
    INVOKE(classOf[DynamicMacro], "setToInvoke", "(Lgleam/Macro;)V")
  }
  ...
  override def caseAMacroStmt(node : AMacroStmt) {
    ...
    mv.visitMethodInsn(Opcodes.INVOKESTATIC, call.macro.className, "getInstance", "()Lgleam/Macro;") // macro, value, args
    mv.visitVarInsn(ALOAD, 1)
    ...
    INVOKE(classOf[Macro], "invoke", "(Lgleam/infrastructure/Scope;Ljava/util/Map;Ljava/lang/Object;)Ljava/util/List;")
    addAllNodesFromStack
  }
